  ...
  <body>
    ...
    <section id="home">
      <div class="wrapper">
        <div class="col-a">
          <header>
            <h4>WELCOME TO DOCTORCARE 👋</h4>
            <h1>Simplified health care for all</h1>
          </header>

          <div class="content">
            <p>
              DoctorCare doctors go beyond symptoms to treat the root 
              cause of your illness and provide a long-term cure.
            </p>
        ...
        <div class="content">
          <div class="cards">
            ...
            <div class="card">
              ...
              <h3>Autoimmune and inflammation</h3>
              <p>
                Amet minim mollit non deserunt ullamco est sit aliqua dolor do
                amet sint. Velit officia consequat duis enim.
              </p>
    ...
    <section id="about">
      <div class="wrapper">
        <div class="col-a">
          <header>
            <h4>About us</h4>
            <h2>Understand who we are and why we exist</h2>
          </header>
